...
Source0:    https://tahoe-lafs.org/downloads/tahoe-lafs-%{version}.tar.bz2
...
%{python_sitelib}/tahoe_lafs-*

%description
Tahoe-LAFS is a distributed, secure filesystem.

%changelog
* Thu Aug 25 2016 Vladimir Rusinov <vrusinov@google.com> - 1.11.0-1
- Version bump
